...
<?php 
	...
	{		
		$row= mysqli_fetch_array($result);
			...
			$returnValue .= "<td><input style= 'font-size:16pt; font-family:Century Gothic; background:#ccc; color:white;' type= 'text' name= 'userid2' id= 'userid2' class= 'update' value= '" . $row['FACULTYID'] . "' readonly></td>";
			...
			$returnValue .= "</tr>";
				$returnValue .= "<tr><td>Bio Information: </td> <td><textarea style= 'font-size:16pt; font-family:Arial;' name= 'bio' id= 'bio' wrap= 'hard' maxlength= '250' rows= '10' cols= '50'>".$row['BIO']."</textarea>" . 
			"</td>";
			$returnValue .= "</tr>";
			$returnValue .= "<tr><td></td> <td>" . 
